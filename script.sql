...
CREATE TABLE IF NOT EXISTS `yearl_madera`.`FamilleComposant` (
  `idFamilleComposant` INT NOT NULL AUTO_INCREMENT,
  `nom` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `yearl_madera`.`Composant` (
  ...
  `pourcentageCommerciaux` VARCHAR(45) NULL,
  `pourcentageEntreprise` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `yearl_madera`.`Stock`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yearl_madera`.`Stock` (
  `idStock` INT NOT NULL AUTO_INCREMENT,
  `quantite` DOUBLE NULL,
  `Composant_idComposant` INT NOT NULL,
  PRIMARY KEY (`idStock`, `Composant_idComposant`),
  INDEX `fk_Stock_Composant1_idx` (`Composant_idComposant` ASC),
  CONSTRAINT `fk_Stock_Composant1`
    FOREIGN KEY (`Composant_idComposant`)
    REFERENCES `yearl_madera`.`Composant` (`idComposant`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
