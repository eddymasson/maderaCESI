...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'admin.category', 1 => 'admin.blog_post', 2 => 'admin.gamme'));
        $instance->setAdminGroups(array('default' => array('label' => 'default', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'on_top' => false, 'items' => array(0 => array('admin' => 'admin.category', 'label' => 'Category', 'route' => '', 'route_params' => array(), 'route_absolute' => true), 1 => array('admin' => 'admin.blog_post', 'label' => 'Blog post', 'route' => '', 'route_params' => array(), 'route_absolute' => true), 2 => array('admin' => 'admin.gamme', 'label' => 'Gamme', 'route' => '', 'route_params' => array(), 'route_absolute' => true)))));
        $instance->setAdminClasses(array('AppBundle\\Entity\\Category' => array(0 => 'admin.category'), 'AppBundle\\Entity\\BlogPost' => array(0 => 'admin.blog_post'), 'AppBundle\\Entity\\Gamme' => array(0 => 'admin.gamme')));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'admin.category', 1 => 'admin.blog_post', 2 => 'admin.gamme'), $this);
    }
