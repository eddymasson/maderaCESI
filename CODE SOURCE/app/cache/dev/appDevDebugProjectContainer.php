...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'admin.category', 1 => 'admin.blog_post', 2 => 'admin.fournisseur', 3 => 'admin.famillecomposant', 4 => 'admin.gamme', 5 => 'admin.module', 6 => 'admin.insee', 7 => 'admin.client'));
        $instance->setAdminGroups(array('default' => array('label' => 'default', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'on_top' => false, 'items' => array(0 => array('admin' => 'admin.category', 'label' => 'Category', 'route' => '', 'route_params' => array(), 'route_absolute' => true), 1 => array('admin' => 'admin.blog_post', 'label' => 'Blog post', 'route' => '', 'route_params' => array(), 'route_absolute' => true), 2 => array('admin' => 'admin.fournisseur', 'label' => 'Fournisseur', 'route' => '', 'route_params' => array(), 'route_absolute' => true), 3 => array('admin' => 'admin.insee', 'label' => 'Villes', 'route' => '', 'route_params' => array(), 'route_absolute' => true), 4 => array('admin' => 'admin.client', 'label' => 'Clients', 'route' => '', 'route_params' => array(), 'route_absolute' => true))), 'Bureau d\'étude' => array('label' => 'Bureau d\'étude', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'on_top' => false, 'items' => array(0 => array('admin' => 'admin.famillecomposant', 'label' => 'Famille de composant', 'route' => '', 'route_params' => array(), 'route_absolute' => true), 1 => array('admin' => 'admin.gamme', 'label' => 'Gamme', 'route' => '', 'route_params' => array(), 'route_absolute' => true), 2 => array('admin' => 'admin.module', 'label' => 'Module', 'route' => '', 'route_params' => array(), 'route_absolute' => true)))));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'admin.category', 1 => 'admin.blog_post', 2 => 'admin.fournisseur', 3 => 'admin.famillecomposant', 4 => 'admin.gamme', 5 => 'admin.module', 6 => 'admin.insee', 7 => 'admin.client'), $this);
    }
